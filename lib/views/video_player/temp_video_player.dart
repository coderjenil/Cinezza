...
class _VideoPlayerPageState extends State<VideoPlayerPage> {
  ...
  String _selectedLanguage = 'Hindi dub';
  ...
  Widget _buildVideoWithFit() {
    ...
    Widget videoWidget = VideoPlayer(videoController);
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          if (_isFullscreen)
            IconButton(
              icon: Icon(fitIcon, color: Colors.white, size: 24),
  ...
  // =================== DETAILS / RESOURCES UI ===================

  Widget _buildDetailsSection(bool isDark) {
    final movie = widget.movie;
    final textTheme = Theme.of(context).textTheme;

    final hasSeasons = movie.seasons != null && movie.seasons!.isNotEmpty;
        ...
        children: [
            ...
            children: [
              ...
              Text(
                movie.createdAt != null
                    ? DateTime.parse(movie.createdAt!).year.toString()
                    : '2024',
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 10),
              _buildActionButton(Icons.share_rounded, 'Share', isDark, () {}),
              const SizedBox(width: 10),
              _buildActionButton(
          ...
          const SizedBox(height: 4),
          Text(
            'Uploaded by ${movie.description ?? "CinemaFlix"}',
            style: TextStyle(color: Colors.grey[400], fontSize: 12),
          ),

          const SizedBox(height: 12),

          // Language + Season dropdown row
          Row(
            children: [
              Expanded(child: _buildLanguageDropdown(isDark)),
              if (hasSeasons) ...[
                const SizedBox(width: 10),
                Expanded(child: _buildSeasonDropdown(isDark)),
              ],
            ],
          ),
  ...
  Widget _buildLanguageDropdown(bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF202123) : Colors.grey[200],
        borderRadius: BorderRadius.circular(12),
      ),
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          isExpanded: true,
          dropdownColor: isDark ? const Color(0xFF202123) : Colors.white,
          ...
          items: ['Hindi dub', 'English', 'Tamil', 'Telugu']
  ...
  /// Anime-style episode chips row (All + 01, 02, 03, ...)
  Widget _buildEpisodeSelector(bool isDark) {
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemCount: episodes.length + 1, // +1 for "All"
        separatorBuilder: (_, __) => const SizedBox(width: 8),
        itemBuilder: (context, index) {
          if (index == 0) {
            // "All" chip opens bottom sheet with full grid
          ...
          final episodeNo = episode.episodeNo ?? (epIndex + 1);
          final isCurrentEpisode =
              _selectedSeasonIndex == _currentSeasonIndex &&
              epIndex == _currentEpisodeIndex;

          return _episodeChip(
            label: episodeNo.toString().padLeft(2, '0'),
            active: isCurrentEpisode,
            isDark: isDark,
            onTap: () => _playEpisode(_selectedSeasonIndex, epIndex),
          );
        },
      ),
    );
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: active
              ...
              : (isDark ? const Color(0xFF202123) : Colors.grey[300]),
        ),
        child: Center(
          child: Text(
            label,
